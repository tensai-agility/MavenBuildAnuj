...
<html>
    <head>
        <title>Tensai-Agility</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="https://www.tensai-agility.com/w3agility/4/DevOps">
        ...
        <div class="w3-overlay w3-hide-large w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>                  
            <div class="w3-main" style="margin-left:250px;">                  
                ...
                <header class="w3-container w3-theme" style="padding:64px 32px">
                    <h1 class="w3-xxxlarge">DevOps</h1>
                </header>                  
                <div class="w3-container" style="padding:32px">                  
                    ...
                    <p>We have created some responsive W3agility templates for you to use.</p>
                    ...
                    <div class="w3-panel w3-light-grey w3-padding-16 w3-card">
                        ...
                        <div class="w3-content" style="max-width:800px">
                            <a 
                                href="https://www.tensai-agility.com/w3agility/tryw3agility_templates_band.htm" 
                            ...
                            <div class="w3-row">
                                ...
                                <div class="w3-col m6">
                                    <a 
                                        href="https://www.tensai-agility.com/w3agility/tryit.asp?filename=tryw3agility_templates_band&stacked=h" 
                                        target="_blank" 
                                        class="w3-button w3-padding-large w3-dark-grey" 
                    ...
                    <div class="w3-container w3-padding-16 w3-card" style="background-color:#eee">
                        ...
                        <div class="w3-content" style="max-width:800px">
                            ...
                            <div class="w3-row">
                                <div class="w3-col m6">
                                    <a 
                                        href="https://www.tensai-agility.com/w3agility/tryw3agility_templates_blog.htm" 
                                        target="_blank" 
                                        class="w3-button w3-padding-large w3-dark-grey" 
                                        style="width:98.5%">Demo
                                    </a>
                                ...
                                <div class="w3-col m6">
                                    <a 
                                        href="https://www.tensai-agility.com/w3agility/tryit.asp?filename=tryw3agility_templates_blog&stacked=h" 
                                        target="_blank" 
                                        class="w3-button w3-padding-large w3-dark-grey" 
                                        style="width:98.5%">More Templates »
                                    </a>
